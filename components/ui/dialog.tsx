...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-3xl border-t border-border/70 bg-muted/40 p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
